...
class MAX30101 : public MAX3010xMultiLed<MAX30101, MAX30101Sample> {
  friend class MAX3010xMultiLed<
      MAX30101, MAX30101Sample>; //!< Friend declaration for access to private
                                 //!< members from base class
  friend class MAX3010x<MAX30101,
                        MAX30101Sample>; //!< Friend declaration for access to
  ...
  static const uint8_t
      INT_CFG_REG[INT_CNT]; //!< Array to map interrupts to the corresponding
                            //!< configuration register
  static const uint8_t
      INT_CFG_BIT[INT_CNT]; //!< Array to map interrupts to the corresponding
                            //!< configuration bits
  static const uint8_t INT_ST_REG[INT_CNT]; //!< Array to map interrupts to the
                                            //!< corresponding status register
  static const uint8_t INT_ST_BIT[INT_CNT]; //!< Array to map interrupts to the
...
public:
  ...
  static const uint8_t INT_ALC_OVF =
      3; //!< Ambient Light Cancellation Overflow Interrupt
  ...
  enum Led {
    ...
    MAX3010X_LED_GREEN = 2,     //!< Green LED (alias for Green CH 1)
    MAX3010X_LED_GREEN_CH1 = 2, //!< Green LED CH1
    LED_3 = 2,                  //!< LED 3 (alias for Green CH 1)
    MAX3010X_LED_GREEN_CH2 = 3, //!< Green LED CH2
